...
class Helpers
{
  ...
  {
    // Use the Str::ascii() method to remove diacritics and convert to ASCII characters
    $normalizedStr = Str::ascii($str);

    // Remove any remaining non-ASCII characters (e.g., special characters)
    $cleanedStr = preg_replace('/[^\x20-\x7E]/u', '', $normalizedStr);

    // Remove any leading or trailing whitespaces and return the result
