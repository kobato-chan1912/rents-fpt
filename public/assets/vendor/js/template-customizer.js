...
TemplateCustomizer.LANGUAGES = {
  ...
  vi: {
    "panel_header": "TRÌNH ĐIỀU CHỈNH MẪU",
    "panel_sub_header": "Tùy chỉnh và xem trước trong thời gian thực",
    "theming_header": "CHỦ ĐỀ",
    "theme_header": "CHỦ ĐỀ",
    "theme_label": "Chủ đề",
    "style_label": "Kiểu (Chế độ)",
    "style_switch_light": "Sáng",
    "style_switch_dark": "Tối",
    "layout_header": "BẢNG BỐ TRÍ",
    "layout_label": "Bố trí (Menu)",
    "layout_static": "Tĩnh",
    "layout_offcanvas": "Ngoài lề",
    "layout_fixed": "Cố định",
    "layout_fixed_offcanvas": "Cố định ngoài lề",
    "layout_flipped_label": "Menu lật ngược",
    "layout_dd_open_label": "Dropdown khi di chuột qua",
    "layout_navbar_label": "Thanh điều hướng cố định",
    "layout_footer_label": "Chân trang cố định",
    "misc_header": "VỤN VẶN",
    "rtl_label": "Hướng dẫn RTL"
  },
  pt: {
