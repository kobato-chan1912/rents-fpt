  ...
  <div class="row">
    ...
    <div class="row mb-4">
      <div class="col-md-12">
        ...
        <button type="submit" onclick="window.location.href='/admin/real_estate'" class="btn btn-secondary me-sm-3 me-1 data-submit waves-effect waves-light">
    ...
    <div class="content">
        <form @if(!isset($auction)) action="/admin/real_estate" @else action="/admin/real_estate/{{$auction->id}}" @endif method="post">
          @csrf
          <div class="row">
